...
<div style="font-family: inherit; text-align: inherit">${streetAddress}, ${suburb}, ${postalCode}, ${city}</div>
<div style="font-family: inherit; text-align: inherit">${telephoneNumber}</div>
...
<div style="font-family: inherit; text-align: inherit"><span style="color: #0055ff">${
    ...
    <tbody>
      <tr>
        <td style="padding:18px 20px 30px 30px; line-height:22px; text-align:inherit; background-color:#FFFFFF;" height="100%" valign="top" bgcolor="#FFFFFF" role="module-content"><div><div style="font-family: inherit; text-align: inherit">Flow Rate - ${flowRate} L/min</div>
<div style="font-family: inherit; text-align: inherit">Geyser Size - ${geyserSize ? geyserSize   : 'N/A'} L/Min</div>
<div style="font-family: inherit; text-align: inherit">Geyser Size - ${installation ? installation : 'N/A'}</div>
<div style="font-family: inherit; text-align: inherit">Monthly Electricity Savings - ${roundUp(
      monthlySavings
    )}</div>
<div style="font-family: inherit; text-align: inherit">Yearly Savings - ${roundUp(
      yearlySavings
    )}</div>
