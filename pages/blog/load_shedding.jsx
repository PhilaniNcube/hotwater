    ...
    <Fragment>
      ...
      <main>
        <section className="max-w-6xl mx-auto px-4 pt-6 pb-12">
          ...
          <p className="text-md text-gray-600 font-medium mt-4 pr-6">Heating and cooking is more of a challenge during load shedding. Gas appliances are perfect for these uses. Heating and cooking are the main drains on electricity and can make up almost 50% of your electricity usage. If you can take this load of your battery backup it just means that it will last much longer. Consider installing one of our <Link href="quote/start"><a className="font-bold cursor-pointer text-blue-500">Gas Geyser</a></Link> solutions. This can provide instant hot water and will ensure you do not never need to take a cold shower because you woke up with no power in the morning.</p>
        </section>
      </main>
    </Fragment>
  );
