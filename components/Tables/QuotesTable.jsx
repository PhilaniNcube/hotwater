      ...
      <div className="py-12">
        ...
        <div className="mx-auto container pt-8 flex justify-center sm:justify-end items-center">
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="icon icon-tabler icon-tabler-chevron-left text-gray-800 dark:text-gray-100"
              width={24}
              height={24}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
          ...
          <p className="text-gray-800 dark:text-gray-100 fot-normal text-base">
            Page
          </p>
          ...
          <input
            id="selectedPage"
            type="text"
            className="bg-white dark:bg-gray-800 w-8 px-2 mx-2 text-gray-800 dark:text-gray-100 focus:outline-none focus:shadow-outline-gray focus:border focus:border-indigo-700 font-normal flex items-center text-base border-gray-300 rounded border"
            defaultValue={4}
          />
          <p className="text-gray-800 dark:text-gray-100 fot-normal text-base">
            of 20
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="text-gray-800 dark:text-gray-100 icon icon-tabler icon-tabler-chevron-right"
              width={24}
              height={24}
              viewBox="0 0 24 24"
              strokeWidth="1.5"
          ...
          <input
            id="totalPage"
            type="text"
            className="bg-white dark:bg-gray-800 w-10 px-2 mr-2 text-gray-800 dark:text-gray-100 focus:outline-none focus:shadow-outline-gray focus:border focus:border-indigo-700 font-normal flex items-center text-base border-gray-300 rounded border"
            defaultValue={30}
          />
          <p className="-mt-1 text-gray-800 dark:text-gray-100 fot-normal text-base">
            per page
          </p>
        </div>
      </div>
