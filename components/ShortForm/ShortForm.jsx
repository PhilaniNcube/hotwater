                ...
                <div className="block px-6 lg:hidden md:block">
                  <div className="relative top-1 ">
                    <div className="relative w-full mt-2 rounded outline-none dropdown-one bg-gray-50">
                      ...
                      >
                        <span
                          className="pr-4 text-sm font-medium text-sky-700  flex flex-row-reverse	 justify-end gap-x-2 "
                        ...
                        >
                          <div className="flex gap-x-2 ">
                            ...
                            <p className="text-base font-medium leading-none text-sky-700 mt-[1px]">
                              General
                            </p>
                          </div>
                        </span>
                        <div className="relative w-5 h-5 bg-sky-100 rounded">
                          <svg
                            id="rotate"
...
flex flex-row-reverse	 justify-end gap-x-2
 ...
 w-full   p-3 text-base font-medium leading-none text-gray-600 group-hover:text-sky-700 mt-[1px] cursor-pointer group-hover:bg-sky-100 group-hover:font-medium group-hover:rounded"
                          >
                            General
                            <svg
                        ...
                        <div className="flex   gap-x-2 group">
                          <p
                            ...
                            className="
  flex flex-row-reverse	 justify-end gap-x-2
  text-base font-medium leading-none text-gray-600 group-hover:text-sky-700 mt-[1px] cursor-pointer group-hover:bg-sky-100 group-hover:font-medium  group-hover:rounded w-full p-3"
                          >
                            Store
                            <svg
                              className=" group-hover:text-sky-700"
                        ...
                        <div className="relative w-full mt-2 border border-gray-300 rounded outline-none dropdown-one">
                          ...
                          >
                            <a href="javascript:void(0)" className="hover">
                              <p
                                className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-sky-100 hover:font-medium hover:text-sky-700 hover:rounded"
                                onClick={swaptext}
                              >
                                Beginner
                              </p>
